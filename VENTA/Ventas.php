...
<body style="background-color: rgb(241, 155, 41);">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="mi-menu">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a href="..\HTML\Contacto.html" class="nav-link" target="_blank">Contacto</a>
                    </li>
    ...
    <main>
        <section>
            <div class="container-fluid row">
                ...
                <?php require_once "Registroventas.php";  ?>

                    <h2 class="text-center" id="titulo">Registro de Ventas </h2>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control" name="Producto" id="Producto" required>
                    </div>
                ...
                <div class="col-8 p-4">
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <?php require_once "MostrarVentas.php"; ?>
    ...
    <script src="https://kit.fontawesome.com/ec4fc53766.js" crossorigin="anonymous">
    </script>
